  ...
  return (
    <div>
      <form className="flex flex-col relative">
        <div className="flex items-center bg-gray-50 rounded-tl-xl rounded-tr-xl overflow-hidden absolute top-[-3.5rem] px-4">


          <div className="flex items-center bg-gray-50 px-4 py-4 cursor-pointer hover:bg-blue-400 hover:text-white focus:bg-blue-400 focus:text-white">
        ...
        <div className="flex flex-col bg-white border border-white rounded-bl-xl rounded-br-xl rounded-tr-xl w-[70vw] px-4 py-4">
          ...
          <div className="flex items-center ml-4">
            <div className="flex items-center relative">
              <div className="border border-gray-300 rounded-lg flex flex-col z-10 p-4 pr-8">
                ...
                <select name='originLocationCode' className=" text-gray-500 font-bold bg-white outline-none appearance-none" onChange={handleInputChanges} value={travelData?.originLocationCode}>
                  <option></option>
              ...
              <div className="border border-gray-300 rounded-lg flex flex-col ml-4 z-10 p-4 pr-8">
                ...
                <select name='destinationLocationCode' className=" text-gray-500 font-bold bg-white outline-none appearance-none" onChange={handleInputChanges} value={travelData?.destinationLocationCode}>
                  <option></option>
                  <option value={'CGP'}>Chittagong</option>
                  <option value={'DAC'}>Dhaka</option>
                  <option value={'CCU'}>Kolkata</option>
            ...
            <div className="flex items-center relative ml-8">
              <div className="border border-gray-300 rounded-lg flex flex-col z-10 p-4 pr-8">
                ...
                <input name='departureDate' type='date' className="text-gray-500 font-bold bg-white outline-none appearance-none" onChange={handleInputChanges} value={travelData?.departureDate} />
              ...
              <div className="border border-gray-300 rounded-lg flex flex-col ml-4 z-10 p-4 pr-8">
                ...
                <input name='returnDate' type='date' className=" text-gray-500 font-bold bg-white outline-none appearance-none" value={travelData?.returnDate} onChange={handleInputChanges} />
              </div>
            ...
            <div className="flex flex-col items-center ml-6">
              <div className="border border-gray-300 rounded-lg flex flex-col z-10 p-4 pr-16">
                ...
                <select name='adults' className=" text-gray-500 font-bold bg-white outline-none appearance-none" onChange={handleInputChanges} value={travelData?.adults}>
