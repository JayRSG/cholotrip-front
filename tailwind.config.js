...
module.exports = {
	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				'hero-image':
					"linear-gradient(to bottom, rgba(178,34,64,.70), rgba(66,134,244,.70)), url('/image/Join.jpg')",
				'home-image':
					"linear-gradient(to bottom, rgba(0,0,0,.70), rgba(46, 4, 5,.70)), url('/image/home-1.jpg')",
				'home-image-2': "url('/image/home-2.jpg')",
				'home-image-3':
					"linear-gradient(to bottom, rgba(46, 4, 5,.8), rgba(5, 38, 47, .8)), url('/image/home-3.jpg')",
				'home-image-4':
					"linear-gradient(to bottom, rgba(5, 38, 47, .6), rgba(113, 8, 29,.6)), url('/image/home-4.jpg')",
				'home-image-5':
					"linear-gradient(to bottom, rgba(0,0,0,.70), rgba(46, 4, 5,.70)), url('/image/home-5.jpg')",
				'home-image-6':
					"linear-gradient(to bottom, rgba(0,0,0,.70), rgba(46, 4, 5,.70)), url('/image/home-6.jpg')",
				'home-image-7':
					"linear-gradient(to bottom, rgba(0,0,0,.70), rgba(46, 4, 5,.70)), url('/image/home-7.jpg')",
				'home-bg':
					'linear-gradient(to bottom, rgba(46, 4, 5,1), rgba(5, 38, 47, 1))',
				'home-bg-2':
					'linear-gradient(to bottom, rgba(5, 38, 47,1), rgba(113, 8, 29,1))',
				'home-bg-3':
					'linear-gradient(to top, rgba(5, 38, 47,1), rgba(112, 9, 30,1))',
